...
The code for all materials, including this page, is [on Github](https://github.com/petrbouchal/).
...
Closer to the date of the workshop, this page will contain instructions to help you get ready for the workshop, inclusing technical setup.
